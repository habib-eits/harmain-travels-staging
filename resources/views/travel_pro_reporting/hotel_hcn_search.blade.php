            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('hotel.hcn.search1')}}" name="hotel_hcn" id="hotel_hcn" method="post">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3  col-sm-3 mt-2">
                                    <label class="control-label" for="DateFrom">Hotel Type  </label>
                                    <select name="HotelType" id="HotelType" class="form-select select2">
                                        <option value="Hotels Without HCN">Hotels Without HCN</option>
