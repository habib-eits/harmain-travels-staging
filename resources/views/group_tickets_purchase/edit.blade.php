                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                ...
                                <i class="fas fa-edit"></i> Edit Group Ticket: {{ $groupTicket->VoucherNo }}
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('group-ticket-purchase.update', $groupTicket) }}" method="POST">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-md-3 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" class="form-control @error('Payable') is-invalid @enderror" 
                                                   id="Payable" name="Payable" value="{{ old('Payable', $groupTicket->Payable) }}" required>
                                            @error('Payable')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
