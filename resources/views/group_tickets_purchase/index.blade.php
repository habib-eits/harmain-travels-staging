                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h3 class="card-title">
                                <i class="fas fa-ticket-alt"></i> Group Tickets Management
                            </h3>
                            <a href="{{ route('group-ticket-purchase.create') }}" class="btn btn-primary">
...
$(document).ready(function() {
    ...
    var table = $('#groupTicketsTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('group-ticket-purchase.data') }}",
            type: 'GET'
        },
        columns: [
    ...
    window.deleteGroupTicket = function(id) {
        ...
        $('#confirmDelete').on('click', function() {
            $.ajax({
                url: "{{ url('group-ticket-purchase') }}/" + id,
                type: 'DELETE',
                data: {
                    _token: "{{ csrf_token() }}"
                },
