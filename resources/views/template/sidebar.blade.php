<div class="vertical-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                 ...
                 <li>
                    ...
                    <a href="{{route('visa-master.index')}}" class="waves-effect">
                        ...
                        <i class="mdi mdi-passport text-info font-size-22"></i>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span key="t-ecommerce">Group Ticket</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li> <a href="{{route('group-ticket-purchase.index')}}" key="t-products">Group Ticket Purchase</a></li>
                        <li> <a href="{{route('group-ticket-sale.index')}}" key="t-products">Group Ticket Sale</a></li>
                        <li> <a href="{{route('group.ticket.register')}}" key="t-products">Group Ticket Search Register</a></li>
    ...
    <a href="javascript:void(0);" class="has-arrow waves-effect">
        ...
        <span key="t-ecommerce">Vouchers Reports</span>
    </a>

    <ul class="sub-menu" aria-expanded="false">
        <li><a href="{{ route('hotel.hcn.search') }}" key="t-products">Update Hotel HCN</a></li>
        <li><a href="{{ route('transport.brn.search') }}" key="t-products">Update Transport BRN</a></li>
        <li><a href="{{ route('view.hotel.voucher') }}" key="t-products">View Hotel Voucher</a></li>
        <li><a href="{{ route('view.hotel.invoice') }}" key="t-products">View Hotel Invoice</a></li>
        <li><a href="{{ route('hotel.voucher.sale.register') }}" key="t-products">Hotel Voucher Sale Register</a></li>
        <li><a href="{{ route('hotel.wise.payment.report') }}" key="t-products">Hotel Wise Payment Report</a></li>
        <li><a href="{{ route('hotel.wise.profit.report') }}" key="t-products">Hotel Wise Profit Report</a></li>
        <li><a href="{{ route('transport.wise.payment.report') }}" key="t-products">Transport Wise Payment</a></li>
        <li><a href="{{ URL('PartyWiseSale') }}" key="t-products">Partywise Sale</a></li>
        <li><a href="{{ URL('VoucherSalemanReport') }}" key="t-products">Saleman Sale Report</a></li>
        <li><a href="{{ URL('VoucherSalemanSummaryReport') }}" key="t-products">Saleman Sale Summary Report</a></li>
        <li><a href="{{ URL('OutStandingInvoice') }}" key="t-products">Outstanding Voucher</a></li>
    </ul>
</li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li> <a href="{{ URL('/SalemanInvoiceBalance') }}" key="t-products">Saleman Invoice
                                Balance</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a key="t-products" href="{{ URL('/TrialBalanceActivity') }}">Trial with acitivity</a>
                        </li>
                ...
                <li>
                    ...
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span key="t-ecommerce">Tarrif Setting</span>
                    ...
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span key="t-ecommerce">Voucher Settings</span>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="{{ route('pnr.index') }}">PNR</a></li>
