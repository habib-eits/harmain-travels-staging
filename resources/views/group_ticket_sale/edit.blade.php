...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
              ...
              <div class="col-12">
                ...
                >
                  <h4 class="mb-sm-0 font-size-18"><i class="fas fa-plus"></i> Edit Group Ticket: {{ $groupTicket->VoucherNo }}</h4>
                  <a href="{{ route('group-ticket-sale.index') }}" class="btn btn-success">
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('group-ticket-sale.update', $groupTicket) }}" method="POST">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-md-3 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('VoucherType') is-invalid @enderror" 
                                                   id="VoucherType" name="VoucherType" value="{{ old('VoucherType', $groupTicket->VoucherType) }}" required>
                                            @error('VoucherType')
                                    ...
                                    <div class="col-md-3 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control @error('VoucherNo') is-invalid @enderror" 
                                                   id="VoucherNo" name="VoucherNo" value="{{ old('VoucherNo', $groupTicket->VoucherNo) }}" required>
                                            @error('VoucherNo')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control @error('Date') is-invalid @enderror" 
                                                   id="Date" name="Date" value="{{ old('Date', $groupTicket->Date) }}" required>
                                            @error('Date')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select select2 @error('SupplierID') is-invalid @enderror" 
                                                ...
                                                @foreach($suppliers as $supplier)
                                                    <option value="{{ $supplier->PartyID }}" {{ old('SupplierID', $groupTicket->SupplierID) == $supplier->PartyID ? 'selected' : '' }}>
                                                        {{ $supplier->PartyName }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    {{-- <div class="col-md-3 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('PNR') is-invalid @enderror" 
                                                   id="PNR" name="PNR" value="{{ old('PNR', $groupTicket->PNR) }}" required>
                                            @error('PNR')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-2 mt-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select select2 @error('PNR') is-invalid @enderror" 
                                                ...
                                                @foreach($pnr as $item)
                                                    <option value="{{ $item->PNR }}" {{ $groupTicket->PNR == $item->PNR ? 'selected' : '' }}>
                                                        {{ $item->PNR }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-3 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('Sector') is-invalid @enderror" 
                                                    id="Sector" name="Sector" required value="{{ old('Sector', $groupTicket->Sector) }}">
                                            @error('Sector')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control @error('DateOfDep') is-invalid @enderror" 
                                                   id="DateOfDep" name="DateOfDep" value="{{ old('DateOfDep', $groupTicket->DateOfDep) }}" required>
                                            @error('DateOfDep')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control @error('DateOfArr') is-invalid @enderror" 
                                                   id="DateOfArr" name="DateOfArr" value="{{ old('DateOfArr', $groupTicket->DateOfArr) }}" required>
                                            @error('DateOfArr')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select select2 @error('AirlineName') is-invalid @enderror" 
                                                ...
                                                @foreach($airline as $airline)
                                                    <option value="{{ $airline->name }}" {{ old('AirlineName', $groupTicket->AirlineName) == $airline->name ? 'selected' : '' }}>
                                                        {{ $airline->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-3 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('FlightNo') is-invalid @enderror" 
                                                   id="FlightNo" name="FlightNo" value="{{ old('FlightNo', $groupTicket->FlightNo) }}" required>
                                            @error('FlightNo')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
  ...
  <div class="input-group">
    <input type="text" id="TicketNo" name="TicketNo" value="{{ $groupTicket->TicketNo }}" class="form-control input-md" style="width: 75%;" minlength="16" pattern=".{16,}" onkeypress="return isNumberKey(event)" required="" maxlength="16">
    <span class="input-group-btn" style="width:50px;">
    <input id="AirlineCode" name="AirlineCode" class="form-control" type="text" value="{{ $groupTicket->AirlineCode }}" maxlength="2" onblur="return UpperCase(id)"></span>
  </div>
</div>
                                    ...
                                    <div class="col-md-3 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('FlightNo') is-invalid @enderror" 
                                                   id="PaxName" name="PaxName" value="{{ $groupTicket->PaxName }}" required>
                                            @error('PaxName')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control @error('FlightNo') is-invalid @enderror" 
                                                   id="TicketPrice" name="TicketPrice" value="{{ $groupTicket->TicketPrice }}" required>
                                            @error('TicketPrice')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" class="form-control @error('Fare') is-invalid @enderror" 
                                                   id="Fare" name="Fare" value="{{ old('Fare', $groupTicket->Fare) }}" required>
                                            @error('Fare')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" class="form-control @error('Quantity') is-invalid @enderror" 
                                                   id="Quantity" name="Quantity" value="{{ old('Quantity', $groupTicket->Quantity) }}" required>
                                            @error('Quantity')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" class="form-control @error('Receivable') is-invalid @enderror" 
                                                   id="Receivable" name="Receivable" value="{{ old('Receivable', $groupTicket->Receivable) }}" required>
                                            @error('Receivable')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control @error('PaymentDueDate') is-invalid @enderror" 
                                                   id="PaymentDueDate" name="PaymentDueDate" value="{{ old('PaymentDueDate', $groupTicket->PaymentDueDate) }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('PartyID') is-invalid @enderror" 
                                                ...
                                                @foreach($parties as $party)
                                                    <option value="{{ $party->PartyID }}" {{ old('PartyID', $groupTicket->PartyID) == $party->PartyID ? 'selected' : '' }}>
                                                        {{ $party->PartyName }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-3 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" class="form-control @error('ExRate') is-invalid @enderror" 
                                                   id="ExRate" name="ExRate" value="{{ old('ExRate', $groupTicket->ExRate) }}">
                                            @error('ExRate')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('CareOf') is-invalid @enderror" 
                                                   id="CareOf" name="CareOf" value="{{ old('CareOf', $groupTicket->CareOf) }}">
                                            @error('CareOf')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <textarea class="form-control @error('Remarks') is-invalid @enderror" 
                                              id="Remarks" name="Remarks" rows="3">{{ old('Remarks', $groupTicket->Remarks) }}</textarea>
                                    @error('Remarks')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mt-2">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fas fa-save"></i> Update Group Ticket
                                    </button>
